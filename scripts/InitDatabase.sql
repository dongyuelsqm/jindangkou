create table products(id int primary key AUTO_INCREMENT, name VARCHAR(100) not null, department_id int not null, unit_price float not null, description VARCHAR(500), picture VARCHAR(100), minimum int, postal VARCHAR(10), code VARCHAR(20), deal_date datetime);
