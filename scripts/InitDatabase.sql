...
create table sub_orders(id int primary key AUTO_INCREMENT, product_id int, order_id int, color_id VARCHAR(10), size_id VARCHAR(10), number int);
create table addresses(id int primary key not null AUTO_INCREMENT, open_id VARCHAR(100) not null, name VARCHAR(100), phone VARCHAR(100), province VARCHAR(100) not null, city VARCHAR(100) not null, district VARCHAR(100) not null, detail VARCHAR(100));
