...
create table orders(id int primary key AUTO_INCREMENT, discount float, open_id int not null, address_id int not null, deal_date datetime, ship_id varchar(200), state int, express_number varchar(100), method_price FLOAT , actual_price FLOAT, unifiedOrder_id INT) character set = utf8;
...
insert into orders (discount, open_id, address_id, deal_date, ship_id, state, express_number, method_price, actual_price, unified_order) values (1.1, 1, 1, '2012-1-1', 'd', 1, 'dd', 1.1, 1.1, 1);
