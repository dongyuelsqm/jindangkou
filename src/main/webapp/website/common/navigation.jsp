      ...
      <div class="navs-wrapper">
          <div class="container clearfix">
              ...
              <ul class="navs pull-right" id="log">
                  <li id="nav-7" style="padding-right: 0;">
                      <a href="./member/personal-center.action" >
          ...
          <li id="nav-8" style="padding: 0;"><a href="javascript:" id="logout">退出</a></li>
              ...
              <ul class="navs pull-right" id="navs">
                 <li id="nav-1"><a href="./index.jsp" >首页</a></li>
                 <li id="nav-2"><a href="#" >产品大全</a></li>
                 <li id="nav-3"><a href="#" >免费试用</a></li>
                 <li id="nav-4"><a href="#" >签约服务</a></li>
              </ul>
          </div>
      </div>
  </div>