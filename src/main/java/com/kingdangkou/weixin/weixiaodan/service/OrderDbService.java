...
public class OrderDbService {
    ...
    public void record(String customer_id, int product_id, int number, int address_id){
    ...
    public void get(int customer_id){
        ...
        List orders = session.createQuery("From Order where openID = " + customer_id).list();
